...
export default async function Home() {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      >
        <div className="aspect-[1155/678] w-[36rem] flex-none bg-gradient-to-tr from-indigo-400 to-purple-300 opacity-20 sm:w-[72rem] dark:opacity-10" />
      </div>
      ...
      <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 sm:py-20">
          ...
          <div className="mt-8 grid gap-8 sm:grid-cols-3">
            {[
              ...
              <div key={item.step} className="flex flex-col gap-2">
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-indigo-600 text-sm font-semibold text-white shadow-sm">
                  {item.step}
                </div>
        ...
        {/* Final CTA */}
        <div className="mt-20 flex flex-col items-start gap-4 rounded-lg border border-zinc-200 bg-white p-6 shadow-sm sm:flex-row sm:items-center sm:justify-between sm:p-8 dark:border-zinc-800 dark:bg-zinc-900">
          <div>
